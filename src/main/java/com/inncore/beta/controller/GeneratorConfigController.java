...
import com.inncore.beta.config.AutoGeneratorConfig;
import com.inncore.beta.entity.GeneratorConfig;
import com.inncore.beta.service.GeneratorConfigService;
...
public class GeneratorConfigController extends ApiController {
    ...
    @GetMapping("/tables")
    public R getTables(Integer id) {
        GeneratorConfig config = generatorConfigService.getById(id);
        return R.ok(autoGeneratorConfig.getTables(config));
    }
